...
var (
	awsHVNUniqueID   = uniqueName()
	azureHVNUniqueID = uniqueName()
)
		...
		Steps: []resource.TestStep{
			// Tests create
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "hvn_id", awsHVNUniqueID),
					...
					testLink(resourceName, "self_link", awsHVNUniqueID, HvnResourceType, resourceName),
				),
			},
			// Tests import
			{
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Tests create
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckHvnExists(resourceName),
					resource.TestCheckResourceAttr(resourceName, "hvn_id", azureHVNUniqueID),
					...
					resource.TestCheckResourceAttrSet(resourceName, "created_at"),
					resource.TestCheckResourceAttrSet(resourceName, "state"),
					testLink(resourceName, "self_link", azureHVNUniqueID, HvnResourceType, resourceName),
				),
			},
			// Tests import
			{
